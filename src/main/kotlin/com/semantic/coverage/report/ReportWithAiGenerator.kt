...
class ReportWithAiGenerator {
    ...
    fun generateHtmlReport(reports: List<CoverageReport>, outputPath: String) {
        ...
        val html = buildString {
            ...
            appendLine("""
                    <div class="header">
                        ...
                        <div class="subtitle">
                            ...
                            <p>AI-powered анализ покрытия тестами бизнес-требований</p>
                        </div>
                    </div>
            """.trimIndent())
            ...
            reports.forEachIndexed { index, report ->
                    ...
                    <div class="requirement-card $coverageClass">
                        <div class="requirement-header">
                            <div class="requirement-title">
                                <div class="requirement-id">${report.requirement.id}</div>
                                <h2>${index + 1}. ${report.requirement.title}</h2>
                            </div>
                            <div>
                    ...
                    appendLine("""
                        <div class="ai-analysis-section">
                            ...
                            <div class="ai-explanation">
                                <strong>Общий вывод:</strong> ${aiAnalysis.explanation}
                            </div>
                        ...
                        "<p style='opacity: 0.8;'>Нет данных</p>"
                            ...
                            <details>
                                <summary>Полный AI анализ</summary>
                    ...
                    appendLine("""
                        <div class="matches-section">
                            ...
                            <p style="text-align: center; padding: 20px; color: #6c757d;">
                                Не найдено соответствующих тестов
                            </p>
                        </div>
                    """.trimIndent())
                }
                ...
                if (report.gaps.isNotEmpty()) {
                    appendLine("""
                        <div class="gaps-section">
                            <h3>Выявленные пробелы в покрытии</h3>
                            <ul class="gaps-list">
                ...
                appendLine("""
                        <div class="details-section">
                            <details>
                                ...
                                <div class="details-content">
                                    ...
                                    Максимальное сходство: ${report.matches.maxOfOrNull { it.similarityScore } ?: 0.0}
                                    Среднее сходство: ${report.matches.map { it.similarityScore }.average()}
                    ...
                    """
                                        ...
                                        Сходство: ${match.similarityScore}
                                        Уверенность: ${match.confidence}
                                        Метрики: ${match.testChunk.metadata}
                                        """.trimIndent()
                }}
                                </div>
                            </details>
            ...
            appendLine("""
                    <div class="footer">
                        <p>Generated by Semantic Coverage System v1.0</p>
    ...
    fun generateConsoleReport(reports: List<CoverageReport>) {
        ...
        reports.forEachIndexed { index, report ->
            ...
            report.aiAnalysis?.let { ai ->
                ...
                println("   🤖 AI: ${aiConfidence} ${ai.explanation.take(60)}...")
            }
        ...
        if (aiAnalyses > 0) {
            println("\n🤖 AI Analysis: $aiAnalyses требований проанализировано AI")
        }
        ...
        if (noMatchesReports.isNotEmpty()) {
            println("2. Требования без тестов:")
                ...
                mapOf(
                    ...
                    "aiAnalysis" to report.aiAnalysis?.let { ai ->
                        mapOf(
                            ...
                            "hasRecommendations" to ai.recommendations.isNotEmpty()
                        )
                    },
